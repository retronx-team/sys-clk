...
SysClkApmConfiguration sysclk_g_apm_configurations[] = {
    ...
    {0x92220009, 1785000000, 768000000, 1600000000},
    {0x9222000A, 1785000000, 768000000, 1331200000},
    {0x9222000B, 1020000000, 768000000, 1600000000},
    {0x9222000C, 1020000000, 768000000, 1331200000},
    {0, 0, 0, 0},
};
